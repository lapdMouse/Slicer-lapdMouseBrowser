...
class lapdMouseDBBrowser(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    Tool for accessing and viewing data from the of lapdMouse project data archive. For more details, visit the <a href="https://doi.org/10.25820/9arg-9w56">lapdMouse project</a>.
    """
